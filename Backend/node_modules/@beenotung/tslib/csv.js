...
exports.COMMA = exports.DOUBLE_QUOTE = exports.SINGLE_QUOTE = void 0;
exports.from_csv = from_csv;
exports.to_csv = to_csv;
exports.regular_csv = regular_csv;
exports.csv_to_json = csv_to_json;
exports.json_to_csv_titles = json_to_csv_titles;
exports.json_to_csv = json_to_csv;
exports.csv_to_table_text = csv_to_table_text;
exports.SINGLE_QUOTE = "'";
exports.DOUBLE_QUOTE = '"';
exports.COMMA = ',';
function from_csv(s, separator = exports.COMMA, delimiter = exports.DOUBLE_QUOTE) {
...
function to_csv(rows, separator = exports.COMMA, delimiter = exports.DOUBLE_QUOTE) {
    const res = [];
...
function csv_to_json(rows, titles) {
    if (!titles) {
        rows = rows.slice();
        titles = rows.shift() || [];
    }
...
function json_to_csv_titles(xs) {
    const titles = [];
    const titleCache = {};
    /* build title list */
    for (const x of xs) {
...
function json_to_csv(xs, titles = json_to_csv_titles(xs)) {
    const rows = [titles];
    const n = titles.length;
    for (const x of xs) {
...
function to_width(s, len, repeatChar) {
...
function csv_to_table_text(rows, options) {
    if (rows.length === 0) {
        return '';
    }
    let col_separator = '  ';
